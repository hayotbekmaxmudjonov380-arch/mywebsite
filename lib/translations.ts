...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'common.backToTemplates': 'Back to templates',
  ...
  uz: {
    ...
    'common.backToTemplates': 'Shablonlarga qaytish',
  ...
  ru: {
    ...
    'programs.app1.name': 'Десктоп программы',
    'programs.app1.desc': 'Нативное ПО для Windows, macOS и Linux.',
    'programs.app2.name': 'Мобильные приложения',
    'programs.app2.desc': 'Приложения для iOS и Android на смартфоны и планшеты.',
    'programs.app3.name': 'Веб-сайты',
    'programs.app3.desc': 'Современные сайты, веб-приложения и лендинги.',
    'programs.app4.name': 'Учебные материалы',
    'programs.app4.desc': 'Презентации, документы Word, статьи, курсовые и самостоятельные работы.',
    ...
    'common.backToTemplates': 'Назад к шаблонам',
