...
import styles from './bloom-switch.module.css'

export function BloomSwitch() {
  const { theme, toggleTheme } = useTheme()
  const isDark = theme === 'dark'

  return (
    <label className={styles.bloomSwitch} aria-label="Toggle theme">
      <input
        type="checkbox"
      ...
      <span className={styles.track}>
        ...
        <span className={styles.thumb}>
          <svg className={styles.sun} viewBox="0 0 256 256" aria-hidden="true">
          ...
          <svg className={styles.moon} viewBox="0 0 256 256" aria-hidden="true">
